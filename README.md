...
|---|---|
| Website | titanfantasyfootball.com: a banner of a Titan lifting a football (`titan.svg`, also on the Play feature graphic), what Titan is, how importing rankings works, a sample lineup, features, privacy and FAQ, with Open Titan buttons. The app itself is at `/app/`. In a browser the address always shows the website; only the Android app and home-screen copies go straight to the app |
