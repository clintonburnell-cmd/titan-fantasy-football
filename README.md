...
|---|---|
| Website | titanfantasyfootball.com: what Titan is, how importing rankings works, a sample lineup, features, privacy and FAQ, with Open Titan buttons. The app itself is at `/app/`; anyone already using Titan (and the Android app) goes straight there, and `/?home` always shows the website |
